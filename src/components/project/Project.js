...
const projects = [
    {
      id: 1,
      image:"assets/images/citronix.webp",
      title: 'Citronix',
    ...
    {
      id: 1,
      image:"assets/images/huntersLeague.webp",
    ...
    {
      id: 1,
      image:"assets/images/batiCuisine.webp",
      title: 'BatiCuisine',
      description:'Une application web de gestion agricole qui optimise le suivi des productions de citrons, permettant aux fermiers de maximiser leur rendement et leur productivité.',
      langage: 'JAVA | Spring Boot | ',
    ...
    {
      id: 1,
      image:"assets/images/softVital.png",
      title: 'SoftVital',
      description:'Une application web de gestion agricole qui optimise le suivi des productions de citrons, permettant aux fermiers de maximiser leur rendement et leur productivité.',
      langage: 'JAVA | Spring Boot | ',
    ...
    {
      id: 1,
      image:"assets/images/evento.webp",
      title: 'Evento',
      description:'Une application web de gestion agricole qui optimise le suivi des productions de citrons, permettant aux fermiers de maximiser leur rendement et leur productivité.',
      langage: 'JAVA | Spring Boot | ',
    ...
    {
      id: 1,
      image:"assets/images/skillder.webp",
      title: 'SkillDer',
      description:'Une application web de gestion agricole qui optimise le suivi des productions de citrons, permettant aux fermiers de maximiser leur rendement et leur productivité.',
      langage: 'JAVA | Spring Boot | ',
...
//         key={index}
//         className="bg-base-100 shadow-md rounded-lg overflow-hidden animate-flip-down"
//       >
//         <figure>
//           <div className="relative w-full h-56">
//             <img
