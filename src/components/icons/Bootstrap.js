export default function Bootstrap({ className = "w-32 h-32" }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 128 128" className={className}>
            ...
            <defs>
                ...
                <filter id="deviconBootstrap2" width="197" height="249" x="161.9" y="135.46" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse">
